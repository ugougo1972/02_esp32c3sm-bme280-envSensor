...
### 補足
ENノードは100kΩでGNDへプルダウンする。
これは未制御時にTPS63802をOFF側へ倒すための安全設計である。
ただし、TPS63802がXIAO本体へも給電している場合、D6(GPIO43)をLOWにするとXIAO自身も停止する可能性がある。
DeepSleep保持目的のプルアップではなく、EN制御の実機確認対象として扱う。
