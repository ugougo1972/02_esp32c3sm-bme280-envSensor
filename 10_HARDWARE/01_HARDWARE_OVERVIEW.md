...
- OLED、DS3231、MCP23017 と同一の I2C バスにぶら下げる
...
- ヘッダ付きCSVを採用する
- 起動ごと初期化、追記型運用を基本とする
- Deep Sleep前に CS=HIGH 固定と SPI.end() を実施すること
...
| 4P | EN | メイン基板GPIO43（Deep Sleep制御用） |
...
- [COMPLETE] GPIO43 Hi-Z対策（100kΩプルアップ）**確定**
- [COMPLETE] microSD CS処理（SPI.end()）**確定**
- [COMPLETE] Encoder復帰（EXT0/EXT1）**確定**
